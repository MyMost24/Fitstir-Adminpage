                                ...
                                <v-stepper-content step="2">
                                    <v-card class="mb-12" height="400" align="center">
                                        ...
                                        <div>
                                            ...
                                            <input ref="imageuploader" class="d-none" type="file" accept="image/jpeg,image/png" @change="onSelectImage">
                                        </div>
                                    </v-card>
                                            ...
                                            <div v-for="item,index in tags" :key="index">
                                                ...
                                                <div>
                                                    ...
                                                    <div v-for="detail, index in item.tag_detail" :key="index">
                                                        ...
                                                        <input id="tag_checkbox" type="checkbox" :name="`tag${index}`" :id="`tag${index}`" :value="detail.id" v-model="form.tag_type">
...
export default {
    ...
    methods: {
      ...call('video/*'),
        ...
        async loadData() {
            this.tags = await this.$store.dispatch('tag/getTags')
        },
        async saveData() {
            let data = await this.storeVideo(this.form)
            console.log(data)
            return data
        }
    },
